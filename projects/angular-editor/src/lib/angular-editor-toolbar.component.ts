...
export class AngularEditorToolbarComponent {
  ...
  buttons = ['bold', 'italic', 'underline', 'strikeThrough', 'justifyLeft', 'justifyCenter',
    'justifyRight', 'justifyFull', 'indent', 'outdent', 'insertUnorderedList', 'insertOrderedList', 'link', 'insertFile', 'insertImage', 'insertVideo'];
